...
try
{
    ...
    $SqlEjecucuionHistoria = consultaUnaColumnaRestriccion("detalle,contenido", "filosofia","informacion","detalle");
    ...
    if ($ResultadoEjecucion->num_rows > 0 ) 
    {
        ...
        while($FilasResultado = mysqli_fetch_assoc($ResultadoEjecucion)  ) 
        {
            ...
            $ConteoFilas = utf8_encode($FilasResultado["contenido"]);
    ...
    {
        $ResultadoRetornar[] = array("filosofia" => "Error 401");
